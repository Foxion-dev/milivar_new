    ...
    switch ($one_deliver["ID"]){
        case "31":
            ...
            $arResult["DELIVERY"][$key_deliver]["DESCRIPTION"]= <<<DELTEXT
                ...
                <h3 style="margin-bottom:30px"><a href="https://yandex.ru/maps/-/CCQzbRtvcA" rel="nofollow" target="_blank">Схема - как пройти в магазин "Мыловар Про"</a></h3>

                <div class="order-page__pickup order-page__pickup--msk pickup--msk">
                    <div class="pickup--msk__left">
                        <a href="https://yandex.ru/maps/-/CCQvrIWWLC" rel="nofollow" target="_blank">
                            <img src="/local/templates/milovar/images/order/shema.png"  />
                        </a>
                    </div>
                    <div class="pickup--msk__right">
                        <img class="pickup--msk__img" src="/local/templates/milovar/images/order/12.png" alt="" />
                        <img class="pickup--msk__img"  src="/local/templates/milovar/images/order/3.png" alt="" />
                        <img class="pickup--msk__img"  src="/local/templates/milovar/images/order/5.png" alt="" />
                        <img class="pickup--msk__img"  src="/local/templates/milovar/images/order/7.png" alt="" />
                        <img class="pickup--msk__img"  src="/local/templates/milovar/images/order/2.png" alt="" />
                        <img class="pickup--msk__img"  src="/local/templates/milovar/images/order/9.png" alt="" />
                        <img class="pickup--msk__img"  src="/local/templates/milovar/images/order/10.png" alt="" />
                        <img class="pickup--msk__img"  src="/local/templates/milovar/images/order/4.png" alt="" />       
                        <img class="pickup--msk__img"  src="/local/templates/milovar/images/order/8.png" alt="" />
                    </div>
                </div>
